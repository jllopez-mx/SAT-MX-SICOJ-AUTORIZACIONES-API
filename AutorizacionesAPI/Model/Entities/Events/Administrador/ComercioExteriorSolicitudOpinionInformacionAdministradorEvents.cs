...
{
    public class ComercioExteriorSolicitudOpinionInformacionAdministradorEvents
    {
            ...
            )
        {
            ...
            entityComercio.usuario_modificacion = usuario_modificacion!;
        }
