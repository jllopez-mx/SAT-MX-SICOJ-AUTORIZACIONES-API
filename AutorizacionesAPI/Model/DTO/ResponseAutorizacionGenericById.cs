...
{
    public class ResponseAutorizacionGenericById : PortadorClass
    {
        ...
        public int? idAutorizacionRelacionadoAvisoSinRespuesta { get; set; }
        public string? noAsuntoExternoAvisoSinRespuesta { get; set; }

        public int? idAutorizacionRelacionadoAvisoConRespuesta { get; set; }
        public string? noAsuntoExternoAvisoConRespuesta { get; set; }
    }
}
