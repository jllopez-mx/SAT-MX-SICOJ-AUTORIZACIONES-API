...
{
    public class RequestUpdateAutorizacionesImpuestosInternosAbogadoLineaValidator : AbstractValidator<RequestImpuestosInternosAbogadoUpdate>
    {
        public RequestUpdateAutorizacionesImpuestosInternosAbogadoLineaValidator()
        {
