...
{
    public class RequestUpdateSolicitudOpinionInformacionAdministradorValidator : AbstractValidator<RequestSolicitudOpinionInformacionAdministradorUpdate>
    {
        public RequestUpdateSolicitudOpinionInformacionAdministradorValidator()
        {
            ...
            RuleFor(c => c.fechaRecepcion)
                ...
                .When(c => c.fechaRecepcion != "undefined");

            RuleFor(c => c.fechaOficioRespuesta)
                .Must(date => date == null || date == "" || FluentValidationGuard.BeValidateDateFormat(date))
                .WithMessage("El formato de la fecha de recepción no es válido.")
                .When(c => c.fechaOficioRespuesta != "undefined");

        }        
    }

    public class RequestSolicitudUpdateOnlyFileValidatorAdministrador  : AbstractValidator<RequestSolicitudOpinionInformacionAdministradorUpdate>
    {
        public RequestSolicitudUpdateOnlyFileValidatorAdministrador()
        {
