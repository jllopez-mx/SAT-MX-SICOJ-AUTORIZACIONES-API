...
{
    public class RequestUpdateAutorizacionesComercioExteriorAdministradorLineaValidator : AbstractValidator<RequestComercioExteriorAdministradorUpdate>
    {
        public RequestUpdateAutorizacionesComercioExteriorAdministradorLineaValidator()
        {
            RuleFor(c => c.Id)
                .NotNull()
