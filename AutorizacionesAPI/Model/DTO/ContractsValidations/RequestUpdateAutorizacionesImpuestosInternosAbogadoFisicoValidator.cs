...
{
    public class RequestUpdateAutorizacionesImpuestosInternosAbogadoFisicoValidator : AbstractValidator<RequestImpuestosInternosAbogadoUpdate>
    {
        public RequestUpdateAutorizacionesImpuestosInternosAbogadoFisicoValidator()
        {
