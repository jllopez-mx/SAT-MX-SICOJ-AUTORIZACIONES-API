...
{
    public class RequestAvisoSinRespuestaValidator : AbstractValidator<RequestAvisoSinRespuesta>
    {
        public RequestAvisoSinRespuestaValidator()
        {
            ...
            //RuleFor(c => c.folio)
            //    .NotNull().WithMessage("Folio es requerido.")
            //    .NotEmpty().WithMessage("Folio es requerido.")
            //    .MaximumLength(1000).WithMessage("Número folio solo puede contener un máximo de 1000 caracteres.");
            ...
            RuleFor(c => c.idTipoArchivo)
                .GreaterThan(0).WithMessage("Tipo documento no es válido.");
