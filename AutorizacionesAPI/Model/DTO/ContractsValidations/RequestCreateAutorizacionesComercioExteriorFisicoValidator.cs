...
{
    public class RequestCreateAutorizacionesComercioExteriorFisicoValidator : AbstractValidator<RequestComercioExteriorFisicoCreate>
    {
        public RequestCreateAutorizacionesComercioExteriorFisicoValidator()
        {
