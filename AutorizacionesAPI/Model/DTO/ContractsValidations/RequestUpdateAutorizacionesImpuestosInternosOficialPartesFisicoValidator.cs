...
{
    public class RequestUpdateAutorizacionesImpuestosInternosOficialPartesFisicoValidator : AbstractValidator<RequestImpuestosInternosOficialPartesUpdate>
    {
        public RequestUpdateAutorizacionesImpuestosInternosOficialPartesFisicoValidator()
        {
            RuleFor(c => c.Promovente).NotNull().NotEmpty().WithMessage("Promovente es requerido");
            ...
            RuleFor(c => c.DomicilioPromovente)
                .NotNull()
                .WithMessage("Domicilio promovente es requerido.")
                .NotEmpty()
                .WithMessage("Domicilio promovente es requerido.");
