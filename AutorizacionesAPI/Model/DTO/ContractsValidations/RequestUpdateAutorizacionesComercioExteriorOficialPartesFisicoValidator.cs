...
{
    public class RequestUpdateAutorizacionesComercioExteriorOficialPartesFisicoValidator : AbstractValidator<RequestComercioExteriorOficialPartesUpdate>
    {
        public RequestUpdateAutorizacionesComercioExteriorOficialPartesFisicoValidator()
        {
            RuleFor(c => c.Id)
                .NotNull()
