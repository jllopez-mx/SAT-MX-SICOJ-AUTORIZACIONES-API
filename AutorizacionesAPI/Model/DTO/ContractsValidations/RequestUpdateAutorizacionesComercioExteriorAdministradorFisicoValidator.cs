...
{
    public class RequestUpdateAutorizacionesComercioExteriorAdministradorFisicoValidator : AbstractValidator<RequestComercioExteriorAdministradorUpdate>
    {
        public RequestUpdateAutorizacionesComercioExteriorAdministradorFisicoValidator()
        {
            RuleFor(c => c.Id)
                .NotNull()
