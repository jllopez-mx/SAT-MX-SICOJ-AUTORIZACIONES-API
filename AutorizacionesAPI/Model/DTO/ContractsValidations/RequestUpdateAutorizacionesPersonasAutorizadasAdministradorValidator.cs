...
{
    public class RequestUpdateAutorizacionesPersonasAutorizadasAdministradorValidator : AbstractValidator<RequestPersonasAutorizadasAdministradorUpdate>
    {
        public RequestUpdateAutorizacionesPersonasAutorizadasAdministradorValidator()
        {
            RuleFor(c => c.Nombre)
                .NotNull()
