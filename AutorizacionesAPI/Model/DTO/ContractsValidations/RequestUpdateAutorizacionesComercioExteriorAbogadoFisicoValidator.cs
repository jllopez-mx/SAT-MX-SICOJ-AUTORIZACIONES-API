...
{
    public class RequestUpdateAutorizacionesComercioExteriorAbogadoFisicoValidator : AbstractValidator<RequestComercioExteriorAbogadoUpdate>
    {
        public RequestUpdateAutorizacionesComercioExteriorAbogadoFisicoValidator()
        {
            RuleFor(c => c.Id)
                .NotNull()
