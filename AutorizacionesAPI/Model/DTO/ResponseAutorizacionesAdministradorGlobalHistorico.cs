...
{
    public class ResponseAutorizacionesAdministradorGlobalHistorico : PortadorClass
    {
        ...
        public int? idTipoAsuntoCumplimentacion { get; set; }
        public string? tipoAsuntoCumplimentacion { get; set; }
        ...
        public string fechaControlSolicitudes { get; set; } = null!;
        public int? idUnidadAdministrativaCentral { get; set; }
        public string? unidadAdministrativaCentral { get; set; }
        public bool tieneCumplimentacion { get; set; }
    }
}
